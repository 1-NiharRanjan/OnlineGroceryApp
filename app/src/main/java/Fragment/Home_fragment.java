...
import techview.gdk.AppController;
import techview.gdk.MainActivity;
import techview.gdk.R;
...
public class Home_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_veg = (RecyclerView) view.findViewById(R.id.rv_veg);
        rv_services= (RecyclerView) view.findViewById(R.id.rv_services);
        //rl_view_all = (RelativeLayout) view.findViewById(R.id.rl_home_view_allcat);

        rv_items.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.HORIZONTAL,false));
        rv_veg.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.HORIZONTAL,false));
        rv_services.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.HORIZONTAL,false));
        ...
        if (ConnectivityReceiver.isConnected()) {
            ...
            //makeGetCategoryRequest1("45");
            //makeGetCategoryRequest2("46");
        }
    ...
    private void makeGetCategoryRequest1(String parent_id) {
    ...
    private void makeGetCategoryRequest2(String parent_id) {
